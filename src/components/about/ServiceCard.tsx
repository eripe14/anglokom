...
export default function ServiceCard(
    ...
    return (
        <div className="relative w-full h-full group">
            <div className="w-full h-full p-6 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform group-hover:scale-[1.02] group-hover:-translate-y-1">
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                <div className="relative w-80 bg-white text-gray-800 p-4 rounded-xl shadow-2xl border border-gray-200">
                    <div className="mb-2">
                        <h4 className="text-lg font-bold text-blue-800 mb-2">{tooltipTitle}</h4>
                        <p className="text-sm text-gray-700 leading-relaxed">{tooltipDescription}</p>
                    </div>
